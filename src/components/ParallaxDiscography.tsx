  ...
  return (
    <div className="space-y-12 md:space-y-16 animate-[fadeIn_0.5s_ease-out]">
      ...
      <div className="space-y-3 pb-6 border-b border-[#2a2520]">
        ...
        <h2 className="text-4xl sm:text-6xl font-bold tracking-tight text-[#f0ebe3]">
          SELECTED RELEASES.
        </h2>
        <p className="text-sm sm:text-base text-[#a89880] max-w-xl font-mono leading-relaxed">
          Scroll down naturally through the multi-layer parallax stream to examine architectural scopes, query optimizations, and production ledgers.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
        ...
        {/* Left Column: Sticky Turntable Deck (Follows current active track with needle sync) */}
          ...
          {PLAYABLE_TRACKS.map((t, idx) => {
            ...
            return (
              <div
                ...
                className={`project-parallax-card relative rounded-3xl p-6 sm:p-10 border transition-all duration-700 overflow-hidden group shadow-2xl ${
                  isActive
                    ? "bg-[#141210] border-[#4a4035] shadow-[0_20px_60px_rgba(0,0,0,0.9)]"
                    : "bg-[#110f0d]/90 border-[#26211c] hover:border-[#383028]"
                }`}
              >
                {/* ── PARALLAX LAYER 1: Massive Background Watermark Track Number (Depth 0.3x) ── */}
                <div className="absolute top-2 right-4 pointer-events-none z-0 select-none overflow-hidden">
                  <span
                    className="text-[120px] sm:text-[180px] font-bold tracking-tighter font-mono leading-none block opacity-10 group-hover:opacity-20 transition-opacity duration-700"
                ...
                {/* ── PARALLAX LAYER 2: Midground Content Core (Speed 1.0x) ── */}
                <div className="relative z-10 space-y-6">
                  
                  {/* Track Meta Header */}
                  <div className="space-y-2 border-b border-[#24201a] pb-4">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        ...
                        {t.storyChapter} · {t.bpm} BPM · {t.genre}
                      </span>
                  ...
                  <div className="space-y-2">
                    <h4 className="text-[11px] font-mono text-[#5c5248] uppercase tracking-widest">
                      // ARCHITECTURAL SCOPE
                    </h4>
                  ...
                  {/* ── PARALLAX LAYER 3: Foreground Engineering Deliverables Chips (Speed 1.5x) ── */}
                  <div className="space-y-3 pt-1">
                    ...
                    <div className="grid grid-cols-1 gap-2.5">
                      {project.deliverables.map((deliv, dIdx) => (
                        <div
                          key={dIdx}
                          className="flex items-start gap-3 p-3 sm:p-3.5 rounded-xl bg-[#1c1916]/90 border border-[#26211c] hover:border-[#383028] text-xs sm:text-sm text-[#f0ebe3] shadow-md transition-all group-hover:translate-x-1"
                        >
                          <span
                          ...
                          <span className="leading-relaxed text-[#dcd5cc]">{deliv}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="pt-5 border-t border-[#24201a] flex flex-wrap items-center justify-between gap-4">
