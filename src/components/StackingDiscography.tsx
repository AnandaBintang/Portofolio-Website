    ...
    >
      ...
      <div className="space-y-3 pb-6 border-b border-[#2a2520] relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-[#1c1916] border border-[#332d26] text-xs font-mono text-[#4a9eff]">
          ...
          <span>STUDIO DISCOGRAPHY · 4 STACKED VINYL RELEASES</span>
        </div>
        ...
        <p className="text-xs sm:text-sm md:text-base text-[#a89880] max-w-xl font-mono leading-relaxed">
          Scroll down naturally. Each release stacks on top of the previous record sleeve like flipping through vinyl crates.
        </p>
      </div>

      {/* ── 3D Stacking Record Sleeves Container ── */}
      <div className="space-y-16 sm:space-y-24 pb-20 relative">
        {PLAYABLE_TRACKS.map((t, idx) => {
          ...
          const stickyTopOffset = 88 + idx * 16; // Incremental stacking shelf offset (88px, 104px, 120px, 136px)
          ...
          return (
            ...
            >
              {/* Master 3D Vinyl Sleeve Jacket Card */}
              <div
              ...
              >
                ...
                <div className="relative z-10 space-y-6 max-w-2xl">
                  ...
                  <div className="space-y-1.5">
                    <h4 className="text-[10px] sm:text-[11px] font-mono text-[#5c5248] uppercase tracking-widest">
                      // ARCHITECTURAL SCOPE
                    </h4>
